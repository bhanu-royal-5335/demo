...
class Layer0Orchestrator:
    ...
    """
    def run_pipeline(self, query: str, max_iterations: int = None, api_key: str = "", selected_agent: str = "auto") -> Dict[str, Any]:
        ...
        # Layer 3: Bounded Generation (AI Agent)
        t3_start = time.time()
        l3_out = layer3_engine.execute(query, l2_out, api_key=api_key, selected_agent=selected_agent)
